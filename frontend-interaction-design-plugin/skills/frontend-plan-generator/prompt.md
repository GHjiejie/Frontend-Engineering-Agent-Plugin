...
Development tasks may describe page structure, API adapters, list behavior, dialogs, validation, tests, integration, and review. They must not contain generated source code or authorize repository changes.
