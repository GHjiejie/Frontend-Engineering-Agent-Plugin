...
Use short stable Mermaid node IDs such as `A`, `B`, and `C1`. Quote labels containing punctuation. Do not place implementation tasks, source code, endpoint guesses, or component architecture in this artifact.
