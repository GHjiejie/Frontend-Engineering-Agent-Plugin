...
description: Collect required inputs, obtain explicit confirmation of the frontend-spec output directory, and generate or resume an isolated end-to-end frontend development specification. Use whenever a user asks to add, create, build, design, plan, continue, or update a frontend feature—including phrases such as “增加功能”, “新增页面”, “继续这个需求”, “开发前端功能”, or “现在要做”—even when no PRD, prototype, API, or output path has been provided yet. Do not use this skill to implement application code or scan the surrounding project.
---
